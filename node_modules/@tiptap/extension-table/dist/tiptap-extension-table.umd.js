(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@tiptap/core'), require('prosemirror-tables')) :
  typeof define === 'function' && define.amd ? define(['exports', '@tiptap/core', 'prosemirror-tables'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['@tiptap/extension-table'] = {}, global.core, global.prosemirrorTables));
}(this, (function (exports, core, prosemirrorTables) { 'use strict';
      ...
      addCommands() {
          return {
              ...
              toggleHeaderColumn: () => ({ state, dispatch }) => {
                  return prosemirrorTables.toggleHeaderColumn(state, dispatch);
              },
              toggleHeaderRow: () => ({ state, dispatch }) => {
                  return prosemirrorTables.toggleHeaderRow(state, dispatch);
              },
